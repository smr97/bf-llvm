...
Ast::Node* Ast::Node::try_parse(fstream &in) {
    while(true) {
        ...
        switch (c) {
            case '+':
                return new Ast::PlusNode();
            case '-':
                return new Ast::MinusNode();
            case '<':
                return new Ast::ShiftLNode();
            case '>':
                return new Ast::ShiftRNode();
            case '.':
                return new Ast::PrintNode();
            case ',':
                return new Ast::ReadNode();
            case '[':
